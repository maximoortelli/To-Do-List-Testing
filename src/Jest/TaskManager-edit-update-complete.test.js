...
const MyManager = require('./TaskManager-toTest.js');
const theInject = require('./injectFullTaskListOnDOM.js');

describe('TaskManager - Edit task description on LocalStorage', () => {
  let taskList;

  beforeEach(() => {
    taskList = new MyManager();
  });
...
describe('TaskManager - Clear all Completed tasks from the DOM', () => {
  ...
  test('Should Remove all Completed tasks from the DOM', () => {
    ...
    theInject(taskListHolder, tasklistElements);
